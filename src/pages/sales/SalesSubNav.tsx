...
const links: Array<{ to: string; label: string; end: boolean; hideForAgent?: boolean }> = [
  { to: routes.sales, label: 'Leads', end: true },
  { to: routes.salesFollowUps, label: 'Follow-ups', end: false },
  { to: routes.salesConversions, label: 'Conversions', end: false },
  { to: routes.salesPerformance, label: 'Performance', end: false, hideForAgent: true },
]
