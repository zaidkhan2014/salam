...
type DeletedAccountsDetailLocationState = {
...
export default function DeletedAccountsLeadDetailPage() {
  ...
  const state = location.state as DeletedAccountsDetailLocationState | null
  ...
  return (
    <section className="min-w-0 space-y-4">
      <PageHeader title="Deleted Account Lead Detail" description={`Manage deleted-account sales lead for ${userId ?? '--'}.`} />
