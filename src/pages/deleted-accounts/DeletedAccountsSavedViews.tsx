...
interface DeletedAccountsSavedViewsProps {
  currentSearch: string
  onLoadView: (search: string) => void
}

export function DeletedAccountsSavedViews({ currentSearch, onLoadView }: DeletedAccountsSavedViewsProps) {
...
export function parseDeletedSavedViewFilters(raw: string): URLSearchParams | null {
  try {
